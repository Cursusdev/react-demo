    ...
    <Fragment>
      <FormsProvider>
        <FormAuth className="auth">
          ...
          <div className="form-group">
            <LabelAuth htmlFor="username">Nom d&apos;utilisateur</LabelAuth>
            <InputAuth
              type="text"
              id="username"
          ...
          <div className="form-action">
            ...
            <span className="auth-cgu">Je reconnais avoir lu et compris les <span className="auth-span" onClick={handleCGU}>Conditions Générales d&apos;Utilisation</span> et je les accepte.</span>
            <br />
            {fields.terms && (
